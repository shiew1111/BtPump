...
public class BTConnection {
    ...
    public BTConnection(final BTHandler handler)
    {
        ...
        if (!bluetoothAdapter.isEnabled()) {
            ...
            Log.w("WARNING","Bluetooth was Enable.");
        }
    ...
    public void makeDiscoverable(Activity activity) {
        ...
        activity.startActivity(discoverableIntent); //Activity io.ionic.starter.MainActivity has leaked IntentReceiver com.ionicframework.BtPumpPlugin.PairingRequest@40258f7
            ...
            public void run() {
                ...
                while (true) {
                    try {
                        ...
                        Log.d("PUMP","read "+bytes+": "+ Utils.byteArrayToHexString(buffer,bytes));
                        handler.handleRawData(buffer,bytes);
                    } catch (Exception e) {
                        //e.printStackTrace();
                        //do not fail here as we maybe just closed the socket..
                        Log.d("PUMP","got error in read");
                        handler.ReturnMacToIonic();
                        return;
                    }
                }
            }
    ...
    public void writeCommand(byte[] key) {
        ...
        Log.d("PUMP","writing command: "+sb.toString());
        write(ro);
    }
    ...
    public void write(byte[] ro){
        ...
        try {
            ...
            Log.d("PUMP","wrote "+ro.length+" bytes: "+ Utils.byteArrayToHexString(ro,ro.length));
        }catch(Exception e)
        {
            //e.printStackTrace();
    ...
    public void disconnect() {
        ...
        Log.d("PUMP","disconnect() closed current Connection");
    }
